...
- name: Amazon EC2 Container Service API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/containers/master/_listings/aws-ec2-container-service/action-describecontainerinstances-get.md
x-common:
