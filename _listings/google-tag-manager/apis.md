...
- name: Google Tag Manager API Get Container Versions
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/containers/master/_listings/google-tag-manager/accounts-accountid-containers-containerid-versions-get-postman.md
x-common:
