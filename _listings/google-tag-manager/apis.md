...
- name: Google Tag Manager API Update Container Version
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/containers/master/_listings/google-tag-manager/accounts-accountid-containers-containerid-versions-containerversionid-put.md
x-common:
